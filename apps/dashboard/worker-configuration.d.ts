/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example` (hash: 6a7c9c8c2ba3828fd54772b36bdbc31d)
// Runtime types generated with workerd@1.20260708.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	RAW_IMPORTS: R2Bucket;
	RAW_ARTIFACTS: R2Bucket;
	HYPERDRIVE: Hyperdrive;
	PUBLISH_RESPONSE_QUEUE: Queue;
	ENVIRONMENT: "preview" | "prod" | "local";
	API_URL: "TBD-provision-in-epic-2" | "http://localhost:8787";
	CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE: string;
	CSV_IMPORT: Workflow /* CsvImport from wr-jobs-preview */ | Workflow /* CsvImport from wr-jobs-prod */ | Workflow /* CsvImport from wr-jobs-local */;
}
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE: string;
		CSV_IMPORT: Workflow /* CsvImport from wr-jobs-preview */;
	}
	interface ProdEnv {
		RAW_IMPORTS: R2Bucket;
		RAW_ARTIFACTS: R2Bucket;
		...
		API_URL: "TBD-provision-in-epic-2";
		CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE: string;
		CSV_IMPORT: Workflow /* CsvImport from wr-jobs-prod */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "API_URL" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE">> {}
}
