...
// /settings/imports/:draftId/map. Moved to /settings/imports/new when the
// imports LIST (#137) took over /settings/imports.
//
...
import type { Route } from "./+types/settings.imports.new";

export function meta() {
  return [{ title: "New import · Well Regarded" }];
}
