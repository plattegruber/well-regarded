// Trust coverage (#132): route skeleton + empty state, same shape as today.tsx —
...
const surface = SURFACES.coverage;
...
export default function TrustCoverage({ loaderData }: Route.ComponentProps) {
