// Patient proof (#132): route skeleton + empty state, same shape as today.tsx —
...
export default function PatientProof({ loaderData }: Route.ComponentProps) {
