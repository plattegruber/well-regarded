...
const __ds_ns = (window.WellRegardedDesignSystem_71432a = window.WellRegardedDesignSystem_71432a || {});
...
function Button({
  ...
  const bg = disabled ? v.background : state === "active" ? v.activeBg : state === "hover" ? v.hoverBg : v.background;
...
function IconButton({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      ...
      height: px,
      padding: 0,
      background: solid ? hover && !disabled ? "var(--ink-700)" : "var(--ink-900)" : hover && !disabled ? "var(--gray-100)" : "transparent",
...
try { (() => {
const starPath = "M12 2l2.9 6.2 6.8.8-5 4.7 1.3 6.7L12 17.1 6 20.4l1.3-6.7-5-4.7 6.8-.8z";
function RatingStars({
  ...
  return /*#__PURE__*/React.createElement("span", {
    ...
    return /*#__PURE__*/React.createElement("svg", {
      ...
      d: starPath,
      fill: "var(--gray-300)"
    }), fill > 0 && /*#__PURE__*/React.createElement("g", {
      style: {
...
function Tag({
  ...
  return /*#__PURE__*/React.createElement("span", {
    ...
    style: {
      ...
      background: selected ? "var(--ink-900)" : hover && onClick ? "var(--gray-50)" : "var(--surface-card)",
...
function Toast({
  ...
  const iconColor = tone === "positive" ? "var(--accent-500)" : tone === "negative" ? "#D08573" : "var(--gray-400)";
  return /*#__PURE__*/React.createElement("div", {
    role: "status",
    style: {
      display: "flex",
  ...
  }, icons[tone] || icons.neutral), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1
    }
  }, /*#__PURE__*/React.createElement("div", {
...
const wrIcon = paths => /*#__PURE__*/React.createElement("svg", {
  width: "18",
  height: "18",
  viewBox: "0 0 24 24",
  fill: "none",
...
function AppShell({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Well Regarded"), /*#__PURE__*/React.createElement("nav", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 2
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        gap: 10,
        textAlign: "left",
        font: on ? "600 14px/1 var(--font-sans)" : "500 14px/1 var(--font-sans)",
        color: on ? "var(--accent-700)" : "var(--gray-600)",
  ...
  }, window.WR_DATA.practice.name), /*#__PURE__*/React.createElement(RatingStars, {
...
function OverviewScreen({
  ...
  }, "Your practice is already well regarded. Here is how it is traveling.")), /*#__PURE__*/React.createElement(Button, {
  ...
  }, d.reviews.slice(0, 3).map((r, i) => /*#__PURE__*/React.createElement("div", {
    key: r.id,
    style: {
      padding: "14px 0",
  ...
  }, r.source, " \xB7 ", r.when), /*#__PURE__*/React.createElement("span", {
    style: {
      marginLeft: "auto"
    }
  }, r.status === "waiting" && /*#__PURE__*/React.createElement(Badge, {
    tone: "caution"
  }, "Awaiting reply"), r.status === "attention" && /*#__PURE__*/React.createElement(Badge, {
    tone: "negative"
  }, "Needs attention"), r.status === "replied" && /*#__PURE__*/React.createElement(Badge, {
    tone: "positive"
  }, "Replied"))), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: 0,
      font: "var(--text-quote)",
      fontSize: 15,
  ...
  }, "\u201C", r.text, "\u201D"))))), /*#__PURE__*/React.createElement(Card, {
  ...
  }, "The patients who appreciate you are often the ones least likely to remember to leave a review."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 12
...
function RequestsScreen() {
  ...
  const statusBadge = s => s === "Reviewed" ? /*#__PURE__*/React.createElement(Badge, {
    tone: "positive"
  }, "Reviewed") : s === "Opened" ? /*#__PURE__*/React.createElement(Badge, {
    tone: "brand"
  }, "Opened") : /*#__PURE__*/React.createElement(Badge, null, "Sent");
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Feedback requests"), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "6px 0 0",
      font: "var(--text-body)",
      color: "var(--text-secondary)"
    }
  }, "A thoughtful way to ask. A simple way to keep up.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
    ...
    fullWidth: true,
    onClick: send
  }, "Send request"))), /*#__PURE__*/React.createElement(Card, {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Patient"), /*#__PURE__*/React.createElement("span", null, "Visit"), /*#__PURE__*/React.createElement("span", null, "Channel"), /*#__PURE__*/React.createElement("span", null, "Status")), rows.map((r, i) => /*#__PURE__*/React.createElement("div", {
    key: r.id,
    style: {
      display: "grid",
      gridTemplateColumns: "1.4fr 1.2fr .7fr .8fr",
  ...
  }, r.visit), /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--text-small)",
      color: "var(--text-secondary)"
    }
  }, r.channel), /*#__PURE__*/React.createElement("span", null, statusBadge(r.status))))))), toast && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
      bottom: 24,
      right: 24,
...
function ReviewsScreen() {
  ...
  const waitingCount = d.reviews.filter(r => statusOf(r) !== "replied").length;
  const openReply = r => {
    setReplying(r);
    setDraft(r.rating >= 4 ? `Thank you, ${r.author.split(" ")[0]}. It means a great deal to the whole team that you felt at ease. We look forward to seeing you next time.` : "Thank you for telling us. This is not the experience we want anyone to have — please call the front desk and ask for Carmen so we can put it right.");
  };
  const sendReply = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Everything patients are saying, in one place.")), /*#__PURE__*/React.createElement(Tabs, {
    value: tab,
    onChange: setTab,
    tabs: [{
      value: "all",
  ...
  }, ["All sources", "Google", "Healthgrades"].map(s => /*#__PURE__*/React.createElement(Tag, {
    key: s,
    selected: source === s,
    onClick: () => setSource(s)
    ...
    }, st === "waiting" && /*#__PURE__*/React.createElement(Badge, {
      tone: "caution"
    }, "Awaiting reply"), st === "attention" && /*#__PURE__*/React.createElement(Badge, {
      tone: "negative"
    }, "Needs attention"), st === "replied" && /*#__PURE__*/React.createElement(Badge, {
      tone: "positive"
    }, "Replied"), st !== "replied" && /*#__PURE__*/React.createElement(Button, {
      size: "sm",
      variant: "secondary",
      onClick: () => openReply(r)
    }, "Write reply"))), /*#__PURE__*/React.createElement("p", {
      style: {
        margin: 0,
        font: "var(--text-quote)",
        color: "var(--ink-800)"
  ...
  }, "Nothing here right now."))), /*#__PURE__*/React.createElement(Dialog, {
    open: !!replying,
    onClose: () => setReplying(null),
    title: replying ? `Reply to ${replying.author}` : "",
    description: "Replies post publicly. A suggested draft is below \u2014 make it yours.",
    width: 560,
  ...
  }, "\u201C", replying.text, "\u201D")), /*#__PURE__*/React.createElement("textarea", {
    value: draft,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/app/ReviewsScreen.jsx", error: String((e && e.message) || e) }); }
...
function SiteHeader() {
  ...
  }, ["How it works", "Pricing", "For practices"].map(l => /*#__PURE__*/React.createElement("a", {
    key: l,
    href: "#",
...
function Hero() {
  ...
  }, "For dental practices"), /*#__PURE__*/React.createElement("h1", {
    style: {
      margin: 0,
  ...
  }, "Become the practice patients feel good recommending."), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: 0,
      font: "var(--text-body)",
      fontSize: 17,
  ...
  }, "Well Regarded automatically requests patient feedback, monitors your reviews, and helps your team respond thoughtfully."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 12
    }
...
function HowItWorks() {
  ...
  }, "Good care earns a good reputation.", /*#__PURE__*/React.createElement("br", null), "Well Regarded helps it travel."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
...
function QuoteBand() {
  ...
  }, "\u201CThe patients who appreciate you are often the ones least likely to remember to leave a review.\u201D"), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: 0,
      font: "var(--text-data)",
  ...
  }, "Your practice is already well regarded. Your Google profile should show it."), /*#__PURE__*/React.createElement(Button, {
    size: "lg",
    style: {
      background: "var(--white)",
      color: "var(--ink-900)",
